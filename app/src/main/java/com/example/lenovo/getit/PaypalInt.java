...
public class PaypalInt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paypal_int);
                ...
                if(dataSnapshot.getValue(Integer.class)==1){
                    btnPayNow.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(getApplicationContext(),"You are already a premium user",Toast.LENGTH_SHORT).show();
                        }
                    });
